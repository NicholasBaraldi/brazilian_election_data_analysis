...
WHEN (Select COUNT("CD_MUN_SIT_BIOMETRICA") 
        FROM "perfil_eleitorado_2020.csv"
...
Select 
    ...
    Cast(Replace("CD_MUN_SIT_BIOMETRIA", '"', '') AS varchar(100)) AS "CD_MUN_SIT_BIOMETRIA",
    Cast(Replace("DS_MUN_SIT_BIOMETRIA", '"', '') AS varchar(100)) AS "DS_MUN_SIT_BIOMETRIA",
